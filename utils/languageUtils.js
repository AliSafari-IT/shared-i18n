import { LANGUAGE_COOKIE_NAME, DEFAULT_LANGUAGE, SUPPORTED_LANGUAGES } from '../config/i18n.js';
/**
...
const getIdentityApiUrl = () => {
    ...
    try {
        ...
        if (viteEnv && viteEnv.VITE_IDENTITY_API_URL) {
            resolved = viteEnv.VITE_IDENTITY_API_URL;
        }
...
export const getLanguageFromCookie = () => {
    ...
    const languageCookie = cookies.find(cookie => cookie.trim().startsWith(`${LANGUAGE_COOKIE_NAME}=`));
    if (languageCookie) {
